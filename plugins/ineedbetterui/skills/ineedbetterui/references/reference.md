...
- **Layout**: a sidebar (a pin button that shows or hides the pinned reply, lit while it is showing and the icon alone once the sidebar is collapsed; kind legend; outline with a clear button; and at the bottom the theme and settings buttons) and the conversation, oldest at the top, questions on the right, replies on the left; the pinned reply sits at the top.
